...
//		String path = "/home/cvetan/Downloads/Tavex.xlsx";
		...
		myCoinsStrings.add("1 унци€ златен американски бизон");
		myCoinsStrings.add("1 унци€ американски орел");
		myCoinsStrings.add("30 грама златна китайска панда от 2017");
		myCoinsStrings.add("1 унци€ златна австрийска филхармони€");
		myCoinsStrings.add("1 унци€ златнo јвстралийско  енгуру");
		myCoinsStrings.add("1 унци€ златен канадски кленов лист");
